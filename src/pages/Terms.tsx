  ...
  return (
    <Page width="max-w-3xl">
      ...
      <p className="mt-2 text-sm text-muted">
        Last updated {UPDATED}. CueFloww is a hobby project offered free of charge. See also the{" "}
      ...
      <div className="glass mt-10 p-6 sm:p-8">
        ...
        <Section title="Using CueFloww">
          CueFloww is a browser-based cue player for sound, slides and video. You may use it for personal, educational, community or commercial performances. You need a modern browser; nothing is installed on your machine.
        </Section>

        <Section title="Your account">
          An account is optional, CueFloww works without one. If you create one, keep your password to yourself; you are responsible for what happens under your account. You can sign out at any time, and you can ask for your account and its data to be deleted (see Privacy).
        </Section>

        <Section title="The media you upload">
          <p>You keep all rights to the audio, images and video you upload. By uploading, you confirm you have the right to use that media, and you grant CueFloww only the permission needed to store it and play it back to you.</p>
        ...
        <Section title="Imports and third-party media" id="imports">
          <p>CueFloww can fetch a file from a public link you paste, and can search the <b>Internet Archive</b> and <b>Wikimedia Commons</b>, which host public-domain and freely licensed recordings. Licences there vary by item; several require attribution. Checking the licence of anything you perform publicly is on you.</p>
