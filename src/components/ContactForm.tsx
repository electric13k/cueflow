    ...
    <div className="glass-soft mt-4 flex items-start gap-3 p-5">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted">
          {form.email ? `We'll reply to ${form.email}.` : "Add an email next time if you'd like a reply."}
        </p>
  ...
  return (
    <div className="glass-soft mt-4 p-5">
      <ol className="space-y-4">
        ...
        <li>
          <p className="text-sm font-semibold"><span className="text-accent">3.</span> Where should we reply? <span className="font-normal text-muted">(optional)</span></p>
